...
const (
	...
	// SECURITY: The built-in client secret is no longer hardcoded. It must be provided via
	// the GEMINI_CLI_OAUTH_CLIENT_SECRET environment variable or a custom OAuth client.
